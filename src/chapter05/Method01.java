...
// : 각 매개변수는 자료형과 함께 선언
//      - 일반 변수 정의처럼 동일한 데이터 타입의 생략이 불가! 42번 줄 참고
//      - 메서드 내부에서 지역 변수로 사용
...
public class Method01 {
    public static void main(String[] args){
        ...
        int result2 = calculator.addNumbers(12341,35234);

        System.out.println(result); //80
        System.out.println(result2); //47575
    }
}
