...
class Restaurant {
    ...
    void placeOrder(String dish, String specialRequsets) {
        System.out.println(dish + "*" + specialRequsets);
    }
    void placeOrder(String dish,  int quantity, String specialRequsets) {
        System.out.println(dish + "*" + quantity + "-" + specialRequsets);
    }
