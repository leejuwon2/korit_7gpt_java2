...
// === 생성자 ===
// : 객체(인스턴스)가 생성 될 때 호출되는'인스턴스 초기화 메서드'
...
class Car {
    String color;
    String geerType; // 자동(auto), 수동(manuall)
    int door;
    ...
    Car(String color, String gearType, int door) {
        this.color = color;
        this.geerType = gearType;
        this.door = door;
    }

    Car(String color) {
        //cf) 정의 생성자에서 다른 생성자 호출 시 this() 를 사용
    ...
    void displyInfo() {
        System.out.println(color + "/" + geerType + "/" + door);
    }
}
