...
class School {
    ...
    class Student {
        ...
        public void displayInfo() {
            System.out.println("학교명" + schoolName + ", 학생 이름: " +
                    studentName + "학생 ID: " + studentId);
        }
    }
...
public class B_Inner {
    public static void main(String[] args) {
        ...
        student1.displayInfo(); //학교명유성 초등학교, 학생 이름: 이승아학생 ID: 43

        // Principal: 정적 내부 클래스 외부 클래스의 인스턴스 없이 내부 static 메서드 호출이 가능
