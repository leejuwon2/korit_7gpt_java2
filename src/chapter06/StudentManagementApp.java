...
class Student{
    ...
    void printStudentInfo() {
        System.out.println("ID: " + studentId + ", Name: " + ", Age: " + age + ", Major: " + major + ", GPA: " + gpa );
    }
...
//      +) 클래스 명은 파일 이름과 동일해야 함. (대소문자까지 동일)
...
public class StudentManagementApp {
    ...
    //      +) 프로그램 시작 시 JVM이 접근해야 하기 때문에 반드시 public!
    ...
    // - String[] args: 명령행에서 전달 된 값을 받을 수 있는 매개변수
    ...
    public static void main(String[] args) {
        //학생 추가
        addStudent(1, "이주원", 27, "GPT반", 4.0);
        addStudent(2, "주원", 30, "GP반", 3.7);
        addStudent(3, "이원", 19, "PT반", 2.0);
        addStudent(4, "이주", 20, "G반", 1.8);
