...
class MyMath {
    ...
    String yesReturn() {
        String name = "이주원";
        return name;
        // : 반환타입이 void가 아닌 경우 반드시 해당 타입의 값이 return 뒤에 작성!
    }
...
public class Method03 {
    public static void main(String[] args) {
        ...
        // cf) 실수형 연산(0.0으로 나누기)에서는 오류가 나지 않는다.
        myMath.divide(10,0); // 정수 0으로 나눌 수 없습니다.
        System.out.println(myMath.divide(10,5)); //2


        // 메서드의 호출 : 객체명.메서드명(인자);
        System.out.println(myMath.max(10,9));
        System.out.println(myMath.min(10,20));
    }
}
