...
public class JavaTime {
    public static void main(String[] args) {
        ...
        System.out.println(now); // 12:16:54.151940700

        LocalTime specificTime = LocalTime.of(14,30);
        System.out.println(specificTime); //14:30

        LocalTime thirtyThreeMinutesLater = now.plusMinutes(33);
        System.out.println(thirtyThreeMinutesLater);// 12:51:49.752609200

        LocalTime oneHourAgo = now.minusHours(1);
        System.out.println(oneHourAgo); //11:19:26.912167800
        ...
        System.out.println(nowDateTime);// 2024-12-05T12:24:18.346281900
        System.out.println(nowDateTime.toLocalDate()); // 2024-12-05
        System.out.println(nowDateTime.toLocalTime()); // 12:24:18.346281900

        // cf) 날짜와 시간 포맷팅(formatting)
        LocalDateTime example = LocalDateTime.now();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        System.out.println(example.format(formatter)); //2024-12-05 12:28:43
    }
}
