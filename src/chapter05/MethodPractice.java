...
class BaseballPlayer {
   ...
   // === 정적 메서드 ===
    ...
    void printPlayerInfo() {
        ...
        System.out.println("홈런 수: " + homeRuns);
    }
}
public class MethodPractice {
    public static void main(String[] args) {
        ...
        //인스턴스 생성
        BaseballPlayer player1 = new BaseballPlayer("이주원", 0.325, 16);
        BaseballPlayer player2 = new BaseballPlayer("이원", 0.293, 7);
        BaseballPlayer player3 = new BaseballPlayer("이주", 0.301, 11);
        BaseballPlayer player4 = new BaseballPlayer("주원", 0.274, 9);

        System.out.println(" 총 생성된 선수의 수: " + BaseballPlayer.playerCount);

        player1.updateStatus(0.316,18);
