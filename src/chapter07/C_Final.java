...
// final 키워드
// : 변수, 메서드, 클래스에서 사용 가능
// 1) 변수: 값을 변경 할 수 없는 상수를 선언
// 2) 메서드: 자식 클래스에서 재정의(오버라이드) 할 수 없는 메서드 선언
// 3) 클래스: 상송될 수 없는 클래스를 선언
...
class ChildClass extends MyFinalClass {
     ...
     // 'myMethod()' cannot override 'myMethod()' in
     // 'chapter07.MyFinalClass'; overridden method is final
     //}
