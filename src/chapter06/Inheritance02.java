...
* 2) 생성자: 매개변수X, 매개변수(String name) - 생성자 오버로딩
...
class Mammal {
    ...
    Mammal(String name) {
        ...
        //      필드에 this. 키워드로 구분
        this.name = name; // Mammal 클래스로 생성되는 각 객체(this)
    }
...
* 1) 필드: 이름(name)
* 2) 생성자: 매개변수가 X, 매개변수(String name) - 생성자 오버로딩
* 3) 메서드: 정보출력(greet)
*
 */
