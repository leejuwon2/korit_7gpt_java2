...
*   : 기본 타입과 해당 타입의 Wrapper 클래스 간의 자동변환을 의미
*   - 자바 컴파일러에 의해 자동으로 처리
*
*   1) 박싱(Boxing)
*   : 기본 데이터 타입의 값을 해당하는 Wrapper 클래스의 객체로 변환하는 과정
*   - ing 데이터 타입의 값을 Integer 객체로 변환하는 것을 의미
*
*   2) 언박싱(Unboxing)
...
*           해당 객체의 toStirng() 메서드가 자동으로 호출되어 객체가 보유하고 있는 실제 값이 출력
 */
...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        // 자동 언박싱 : Integer 객체를 기본타입 int 값으로 변환
        int num = integer;
        ...
        // 1) 생성자
        // : Integer(int value) - 주어진 int 값을 갖는 Integer 객체를 생성
        new Integer(50);
