...
//      데이터를 보호하고 객체 간의 의존성을 최소화 하는 역할
// - 캡슐화를 구현,  코드의 보안성을 향샹
...
// public class Modifier {} - Error : 접근제어자 사용 X
...
class ProtedctedClass extends OtherClass { //20번째 줄 참고
    ...
    ProtedctedClass() {
        System.out.println(super.otherField); // 상속받은 부모클래스의 필드(명시)
...
public class A_Modifier {
    public class Modifier {} // 접근제어자 사용 O (중첩 클래스)
    ...
    public static void main(String[] args) {
        ...
        //      해당 클래스 내부에서만 읽을 수 있다.

        DefaultClass defaultClass = new DefaultClass();
        defaultClass.myField = 10;
        defaultClass.myMethod();

        ProtedctedClass protedctedClass = new ProtedctedClass();
        protedctedClass.myField = 20;
        protedctedClass.myMethod();
