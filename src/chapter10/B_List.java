...
public class B_List {
    public static void main(String[] args) {
        ...
        // 데이터 포함 여부 확인
        System.out.println("리스트에 Orange 포함? " + linkedList.contains("Orange")); //리스트에 Orange 포함? true
        System.out.println("리스트에 Strawberry 포함? " + linkedList.contains("Strawberry")); // 리스트에 Strawberry 포함? false]
        ...
        // - 객체 형식 타입: Integer, Character, Boolean (0)
