...
public class I_Practice {
    public static void main(String[] args) {
        List<Employee> employees = Arrays.asList(
                ...
                new Employee("HR","윤대휘", 6000)
        );

        // 1. 급여가 6000 이상인 직원 필터링
        List<Employee> highSalaryEmployee =employees.stream()
        ...
        //{Finance=[Employee(department=Finance, name=전예찬, salary=4000.0)],
        // HR=[Employee(department=HR, name=조승범, salary=7000.0), Employee(department=HR, name=윤대휘, salary=6000.0)],
        // IT=[Employee(department=IT, name=이승아, salary=5000.0), Employee(department=IT, name=김준일, salary=6500.0)]}
